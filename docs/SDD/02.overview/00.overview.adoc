...
=== LS_UC_003: End-User chooses Identity Provider
...
=== LS_UC_004: External Identity Provider Authentication
...
=== LS_UC_005: Request User Attributes through SCIM
...
=== LS_UC_006: Resource registration
...
=== LS_UC_007: Dynamically register a client
...
=== LS_UC_008: JWT expiration validation
...
=== LS_UC_009: External JWT identification
