...
Gluu has a bundled middleware project called Passport, the purpose of which is to facilitate authentication using an external identity provider. To this end, the OIDC interface can be called by an IDP.
